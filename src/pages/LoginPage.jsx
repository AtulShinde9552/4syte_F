...
        const redirectOptions = { state: { showLoader: true } };



        if (result.data.role === "main_admin") {
          navigate("/org/manage-client", redirectOptions);
        } else if (result.data.role === "org") {
          navigate("/org/campaigns", redirectOptions);
        } else if (result.data.role === "client") {
          navigate("/campaigns", redirectOptions);
        }
      } else {
